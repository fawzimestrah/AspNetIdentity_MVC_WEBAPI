        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    SocialStateName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    SocialDescription = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_SocialState", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    firstTimeToAdopt = table.Column<bool>(type: "bit", nullable: true),
                    livingAlone = table.Column<bool>(type: "bit", nullable: true),
                    ResidencyTypeId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        column: x => x.ResidencyTypeId,
                        principalTable: "ResidencyType",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AspNetUsers_SocialState_SocialStateId",
                        column: x => x.SocialStateId,
                        principalTable: "SocialState",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_SocialStateId",
                table: "AspNetUsers",
